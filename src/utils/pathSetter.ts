...
const ensureArray: (value: unknown | unknown[]) => unknown[] = (value: unknown| unknown[]) => (Array.isArray(value) ? value: [value]);
...
const mergeExisting = (left: unknown, right: unknown|unknown[]) =>
  Array.isArray(right) ? mergeArrays(ensureArray(left), right) : right;

export const merge: (left: unknown, right: unknown) => any = (left: unknown, right: unknown) =>
  left === undefined || right === undefined
  ? right === undefined
  ? left
  : right
  : Array.isArray(right)
      ? mergeArrays(ensureArray(left), right as Array<unknown>)
  : isObject(right)
