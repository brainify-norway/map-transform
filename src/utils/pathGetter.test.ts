...
test("should get value at path with array index",
  (t) => {
...
test("should get value at path with array index in the middle",
  (t) => {
...
test("should get array of values at path with open array",
  (t) => {
...
test("should return object when no path",
  (t) => {
    const path = null;
...
test("should return object when empty path",
  (t) => {
    const path = "";
...
test("should return undefined when path is not found",
  (t) => {
    const path = "meta.author";
